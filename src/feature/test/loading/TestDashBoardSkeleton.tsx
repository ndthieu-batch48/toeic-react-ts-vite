...
export default function TestDashBoardSkeleton() {
	return (
		<div className="h-screen w-full container mx-auto p-6">
			<Skeleton className="h-6 w-16 rounded-full mb-10" />
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				{Array.from({ length: 6 }).map((_, i) => (
					<div key={i} className="flex flex-col border rounded-lg p-6 bg-white min-h-[280px]">
