...
import type { HistoryCreateReq, HistoryResp, HistoryResultDetailResp, HistoryResultListRes, HistoryCreateResp, } from "../type/historyType";
...
export const getSaveProgressHistory = async (testId: number): Promise<HistoryResp> => {
