	...
	<svg width="0" height="0" className="absolute">
		<defs>
			<linearGradient id="gemini-accurate" x1="100%" y1="0%" x2="0%" y2="100%">
				...
				<stop offset="60%" style={{ stopColor: 'var(--gemini-blue)', stopOpacity: 0.95 }} />
				<stop offset="75%" style={{ stopColor: 'var(--gemini-red)', stopOpacity: 1 }} />
				<stop offset="88%" style={{ stopColor: 'var(--gemini-yellow)', stopOpacity: 1 }} />
		...
		<div className={`relative inline-flex items-center justify-center ${className}`}>
			{withGlow && (
				<div className="absolute inset-0 blur-md opacity-60">
					<Sparkle
						style={{
							stroke: 'url(#gemini-accurate)',
							fill: 'url(#gemini-accurate)',
							width: `${size}px`,
							height: `${size}px`
						}}
						strokeWidth={2}
