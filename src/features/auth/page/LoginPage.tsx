...
import { TermsNotice } from "@/components/shared/TermNotice";
...
export const LoginPage: React.FC<LoginPageProps> = ({ onAuthSuccess }) => {
	...
	return (
		<div className="bg-primary-foreground min-h-screen pt-3">
			<Card className="md:h-[80vh] md:max-w-6xl md:mx-auto p-0 shadow-xl">
				<CardContent className="flex min-h-full lg:flex-row flex-col p-2">
